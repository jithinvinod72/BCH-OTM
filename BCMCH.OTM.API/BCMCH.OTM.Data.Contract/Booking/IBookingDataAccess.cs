...
namespace BCMCH.OTM.Data.Contract.Booking
{
    public interface IBookingDataAccess
    {
        ...
        Task<IEnumerable<Medicines>> GetEventMedicines(int bookingId);
        Task<IEnumerable<Materials>> GetEventMaterials(int bookingId);
        ...
        Task<IEnumerable<Pathology>> GetPathologyWithOperationId(int operationId);
        ...
        Task<bool> UpdateIsRemovedStatus(int removableDeviceId, bool isRemoved);
